	...
	<body>
		<div id="main_pshysican">
			...
			<div id="physicians">
					...
					<input   type="text" name="text"  id="Designation" style="width: 250px;" /><br/>
					...
					<input   type="text" name="text"  id="Degree" style="width: 250px;" /><br/>
					<label for="Experience">Experience :</label><br/>
					<input   type="text" name="text"  id="Experience" style="width: 250px;" /><br/>
