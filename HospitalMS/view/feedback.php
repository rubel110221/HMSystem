				<div class="view-content">
                    ...
                    <table width="497">
                      ...
                      <tr>
                        <td><p>&nbsp;</p>
                          <p class="style2">PHARMACY</p></td>
                      </tr>
                      <tr>
                        <td>How long did you have to wait before served by a pharmacist</td>
                      </tr>
                      <tr>
                        <td>Less then 10 minutes</td>
                        <td><input name="pharmacy_wait_Less_10_minutes" type="radio" id="pharmacy_wait_Less_10_minutes" value="Excellent"  />
                          &nbsp;Excellent&nbsp;
                          <input name="pharmacy_wait_Less_10_minutes" type="radio" id="pharmacy_wait_Less_10_minutes" value="Good"  />
                          &nbsp;Good&nbsp;
                          <input name="pharmacy_wait_Less_10_minutes" type="radio" id="pharmacy_wait_Less_10_minutes" value="Satisfactory"  />
                          &nbsp;Satisfactory&nbsp;
                          <input name="pharmacy_wait_Less_10_minutes" type="radio" id="pharmacy_wait_Less_10_minutes" value="Poor"  />
                        &nbsp;Poor&nbsp; </td>
                      </tr>
                      <tr>
                        <td>10-30 minutes</td>
                        <td><input name="pharmacy_wait_10_30_minutes" type="radio" id="pharmacy_wait_10_30_minutes" value="Excellent"  />
                          &nbsp;Excellent&nbsp;
                          <input name="pharmacy_wait_10_30_minutes" type="radio" id="pharmacy_wait_10_30_minutes" value="Good"  />
                          &nbsp;Good&nbsp;
                          <input name="pharmacy_wait_10_30_minutes" type="radio" id="pharmacy_wait_10_30_minutes" value="Satisfactory"  />
                          &nbsp;Satisfactory&nbsp;
                          <input name="pharmacy_wait_10_30_minutes" type="radio" id="pharmacy_wait_10_30_minutes" value="Poor"  />
                        &nbsp;Poor&nbsp; </td>
                      </tr>
                      <tr>
                        <td>More then 30 minutes</td>
                        <td><input name="pharmacy_wait_more_30_minutes" type="radio" id="pharmacy_wait_more_30_minutes" value="Excellent"  />
                          &nbsp;Excellent&nbsp;
                          <input name="pharmacy_wait_more_30_minutes" type="radio" id="pharmacy_wait_more_30_minutes" value="Good"  />
                          &nbsp;Good&nbsp;
                          <input name="pharmacy_wait_more_30_minutes" type="radio" id="pharmacy_wait_more_30_minutes" value="Satisfactory"  />
                          &nbsp;Satisfactory&nbsp;
                          <input name="pharmacy_wait_more_30_minutes" type="radio" id="pharmacy_wait_more_30_minutes" value="Poor"  />
                        &nbsp;Poor&nbsp; </td>
                      </tr>
